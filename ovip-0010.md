...
2. Update item in the set of *Connections*:</br>

   | Element         | Value                                                   |
   | :-------------- | :------------------------------------------------------ |
   | `outboundTopic` | `returnTopic` from the *Payload* of received *Envelope* |

   

3. Make the *Node* listen to incoming *Envelopes* associated to this *Connection*.
