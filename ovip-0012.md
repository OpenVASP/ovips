...
```pseudocode
CredentialsInserted(bytes12 indexed vaspId, uint256 indexed credentialRef, bytes32 indexed credentialsHash, string credentials);
```
...
```pseudocode
CredentialsRevoked(bytes12 indexed vaspId, uint256 indexed credentialRef, bytes32 indexed credentialsHash)
```
