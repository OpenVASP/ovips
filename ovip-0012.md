...
**Consumer**
End-user of the VASP Dictionary. Wants to retrieve verifiable Credentials.

**Administrator**
Responsible for managing the content of the VASP Dictionary.

**Owner**
Responsible for managing the lifecycle of the VASP Dictionary
...
The Keccak256 hash of the credentials is calculated as part of this method and inserted into the Dictionary. The credentials themselves are not stored explicitly.
...
**Behavior:**
If there is no existing entry for the VASP Identifier, the method should fail. If this method is called for a VASP Identifier which already exists, the entry in the Dictionary must be removed.
...
**Description:**  
Ends the lifecycle of the VASP Dictionary.
