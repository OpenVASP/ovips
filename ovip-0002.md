```
OVIP: 2
Title: Virtual Asset Account Number (VAAN)
...
This OVIP specifies format and processing requirements for the Virtual Asset Account Number (VAAN), which is used as a customer identifier in the OpenVASP protocol. It is a revision of the initial VAAN specification proposed in the OpenVASP White Paper.

## Specification

### 1. General Description

The Virtual Asset Account Number is a customer identifier as part of the OpenVASP protocol. It is abbreviated as VAAN.

Virtual Asset Service Providers (VASPs) assign VAANs to their customers in order to facilitate virtual asset transfers between VASPs.
...
Unique identifier for the Virtual Asset Service Provider (VASP) who has assigned the VAAN to one of its customers. The VASP Code consists of 8 hexadecimal characters.
