...
Each VASP participating in the OpenVASP protocol deploys and owns a dedicated VASP Contract. It is used to provide the public keys required to decrypt and verify protocol messages that were signed and sent by the VASP. In addition, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1NTE3MjgwM119
-->