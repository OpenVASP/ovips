...
```pseudocode
VASPContractCreated(bytes8 indexed vaspCode, address indexed vaspAddress)
...
```pseudocode
SigningChanged(bytes8 indexed vaspCode, string previousMessageKey, string newMessageKey);
```
