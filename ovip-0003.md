...
It is used to provide the public keys required to decrypt and verify protocol messages that were signed and sent by the VASP. In addition, the VASP Contract can store pointers to registries, where credentials associated with 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDgzNTY1MTgsLTU3NjE3NDQ1LDEzNT
E2ODg5NDldfQ==
-->