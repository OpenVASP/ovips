...
Each VASP participating in the OpenVASP protocol deploys and owns a dedicated VASP Contract. It is used to provide the public keys required to decrypt and verify protocol messages that were signed and sent by the VASP. In addition, the VASP Contract contains pointers to Credential R
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5NzU5ODYxOV19
-->