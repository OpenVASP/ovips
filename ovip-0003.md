...
```pseudocode
createVaspContract(address owner, bytes8 vaspCode, string transportKey, string messageKey, string signingKey) returns address {public}
```
...
```pseudocode
getVaspByCode(bytes8 vaspCode) returns address {public}
```
...
```pseudocode
getVaspCode(address vaspContract) returns bytes8 {public}
```
...
bytes4 channels {public}
string transportKey {public}
string messageKey {public}
string signingKey {public}
```
...
```pseudocode
setChannels(bytes4 newChannels)
```
