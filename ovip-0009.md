...
| 3     | Transport      | Message reliability.                          | [ovip-0008]()                                                | RLPx                   |
...
**Transport**
Provides abstractions and guarantees around messages. Comparable to TCP/UDP in the internet stack. For more details refer to [RLPX](https://github.com/ethereum/devp2p/blob/master/rlpx.md).
