...
| 4     | Authentication   | VASP authentication & authorization.          | [ovip-0003](https://github.com/OpenVASP/ovips/blob/master/ovip-0003.md) | Index + Dictionary     |
| 3     | Transport        | Message reliability.                          | [ovip-0008]()                                                | Whisper Session        |
| 2     | Addressing       | Means of addressing receiver.                 | [ovip-0002](https://github.com/OpenVASP/ovips/blob/master/ovip-0002.md#213-vasp-code) | VASP Code              |
...
**Transport Layer**
Provides abstractions and guarantees around messages. Comparable to TCP/UDP in the internet stack. For our current implementation refer to [ovip-0008]().
